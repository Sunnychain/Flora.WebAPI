...
function Details (props) {
  ...
  useEffect(() => {
    ...
    async function getToken () {
      ...
      try {
        ...
        setNftPrice(onwerInfoTokenHuman);
        const ownerId = await onwerInfoTokenHuman.owner;
        const infoToken = await api.query.tokenNonFungible.ownedTokens(
          ownerId,
          tokenId
        );
  ...
  async function BuyNft (e) {
    ...
    const extrinsic = await api.tx.nftMarket.offer(tokenId, nftPrice.price + 1);
    try {
      const isOwner = await api.query.nftMarket.salesInfo(tokenId);
        ...
        <div className="container px-6 py-2 mx-auto md:flex md:justify-between md:items-center">
          <div className="flex items-center justify-between">
            <div>
              <Link
                to="#"
                className="text-xl text-gray-800 font-semiblod md:text-3xl hover:text-gray-700"
              >
          ...
          <div className="items-center  md:flex">
            <div className="flex flex-col mt-4 space-y-8 md:flex-row md:items-center md:mt-0 md:space-y-0 md:space-x-16">
              <Link
                to="/market"
                className="block font-medium text-gray-700 hover:text-gray-900 hover:underline"
              >
                Return Market
              </Link>
              ...
              {accountAddress !== ''
                ? (
                <div className="flex items-center px-5 py-3 font-medium tracking-wide text-center text-white capitalize bg-blue-600 rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                  <Link
                    to="/perfil"
      ...
      {isLoading
              ...
              <div className="max-w-lg">
                ...
                <div className="grid gap-6 mt-8 sm:grid-cols-2">
                  ...
                  <div className="flex items-center space-x-6 text-gray-800">
                    ...
                    <span>Tree Description : {nft.tree_description}</span>
                  </div>
                  <div className="flex items-center space-x-6 text-gray-800">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="flex items-center space-x-6 text-gray-800">
                    ...
                    <span>Coordiates : {nft.gps_land_coordiates}</span>
                  </div>
                </div>
                <div className="flex mt-20 justify-center">
                  <h2 className="w-full">PRICE:{nftPrice.price} </h2>
                  <button
                    onClick={BuyNft}
                    class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 w-40 rounded"
                    type="button"
                  >
                    Buy
                  </button>
        ...
        <div className="card-descrition">
          <div className="card-pic-wrap">
            <img
              src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1145795/plant-4.png"
