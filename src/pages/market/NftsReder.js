      ...
      <header>
        <nav className="p-6">
          <div className="flex justify-between items-center">
            <h1 className="pr-6 border-r-2 text-2xl font-bold text-gray-500">filter for type</h1>
            <div className="flex justify-between flex-grow">
              <div className="flex ml-6 items-center">
                ...
                <input className="outline-none text-sm flex-grow bg-gray-100" type="text" placeholder="Search nft..." />
              </div>
        ...
        <div className="container mx-auto h-96 rounded-md flex items-center bg-image">
          <div className="sm:ml-20 text-gray-50 text-center sm:text-left">
            <h1 className="mx-auto my-0 text-uppercase">FLORA<br />
              Finance</h1>
            <p className="text-lg inline-block sm:block">come join our community </p>
            <button className="mt-8 px-4 py-2 bg-gray-600 rounded">ABOUT</button>
          </div>
        </div>
      </header>
      ...
      <Modal show={show} onHide={handleClose}>
        {buyState && initial
          ? <div className={initial ? 'end' : ''}>
            ...
            <Modal.Body> you are about to  <strong>END</strong> the purchase, do you want to continue?</Modal.Body>
            <Modal.Footer>
          ...
          : <div>
            {message === 'Finalized'
              ? <div className="alert alert-success " role="alert" style={{ display: 'flex', flexDirection: 'column' }}>
                <p style={{ textAlign: 'center' }}>Nft Buyed</p>
                <button type="button" className="btn btn-success center" onClick={handleClose}>Return</button>
              </div>
              : <div className="alert alert-success " role="alert" style={{ display: 'flex', flexDirection: 'column' }}>
                <p style={{ textAlign: 'center' }}>Await your status: {message}</p>
